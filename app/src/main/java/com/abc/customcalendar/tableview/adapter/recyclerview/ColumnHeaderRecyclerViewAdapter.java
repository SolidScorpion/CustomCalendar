...
import com.abc.customcalendar.tableview.adapter.recyclerview.holder.AbstractSorterViewHolder;
import com.abc.customcalendar.tableview.adapter.recyclerview.holder.AbstractViewHolder;
import com.abc.customcalendar.tableview.sort.ColumnSortHelper;
...
public class ColumnHeaderRecyclerViewAdapter<CH> extends AbstractRecyclerViewAdapter<CH> {
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        AbstractViewHolder.SelectionState selectionState = mTableAdapter.getTableView().getSelectionHandler()
