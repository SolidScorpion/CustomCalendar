...
package com.abc.customcalendar.tableview.adapter.recyclerview;
...
import com.abc.customcalendar.tableview.adapter.ITableAdapter;
...
import com.abc.customcalendar.tableview.layoutmanager.ColumnLayoutManager;
import com.abc.customcalendar.tableview.listener.itemclick.CellRecyclerViewItemClickListener;
...
public class CellRecyclerViewAdapter<C> extends AbstractRecyclerViewAdapter<C> {
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (selectionHandler.isAnyColumnSelected()) {
            ...
            viewHolder.m_jRecyclerView.setSelected(AbstractViewHolder.SelectionState.SELECTED, mTableAdapter
    ...
    public void onViewDetachedFromWindow(RecyclerView.ViewHolder holder) {
        ...
        ((CellRowViewHolder) holder).m_jRecyclerView.setSelected(AbstractViewHolder.SelectionState.UNSELECTED,
