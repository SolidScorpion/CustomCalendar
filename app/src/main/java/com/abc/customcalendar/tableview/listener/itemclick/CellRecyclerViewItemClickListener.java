...
package com.abc.customcalendar.tableview.listener.itemclick;
...
import com.abc.customcalendar.tableview.adapter.recyclerview.CellRowRecyclerViewAdapter;
    ...
    protected boolean clickAction(RecyclerView view, MotionEvent e) {
        ...
        if (childView != null && mGestureDetector.onTouchEvent(e)) {
            ...
            if (getTableViewListener() != null) {
                ...
                getTableViewListener().onCellClicked(holder, column, row, e);
            }
